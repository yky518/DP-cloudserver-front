<template>
  <div id="rechargeRecord">
    <div class="date">
      <span class="date_title">{{i18n.充值时间}}</span>
      <Date-picker
        type="daterange"
        format="yyyy/MM/dd"
        placeholder="选择日期和时间"
    ...
    return {
      ...
      record: [
        ...
        },
        {
          ...
          align:"center",
          renderHeader: (h) => {
            return h("div", {}, this.i18n.充值时间table);
          },
        },
        {
          title: "申请人",
        ...
        },
        {
          ...
          align:"center",
          renderHeader: (h) => {
            return h("div", {}, this.i18n.充值金额table);
          },
        },
        {
          title: "充值完成时间",
