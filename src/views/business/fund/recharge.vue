<template>
  <div id="recharge">
    <div class="balance">
      <div class="balance_title">当前余额:</div>
    ...
    <div class="rechargeMain">
      ...
      <div class="recharge_tip">
        可前往收支明细页面查看<a @click="recordJump()">充值记录</a>
      </div>
    </div>
    <div class="payment">
      <div
      ...
      >
        ...
        />
        <div class="payment_typeName">支付宝</div>
      </div>
      <div
        class="payment_type"
      ...
      >
        <img
          ...
          class="payment_typeImg"
        />
        <div class="payment_typeName">线下汇款</div>
      </div>
    </div>
    <div v-if="payment == 'alipay'">
      <div class="tips">
        <span style="color: #333333">温馨提示：</span> <br />
        不支持信用卡方式充值。
        <br />
        <span style="color: #ff0000"
          >如您有未结清账单，充值后优先抵扣未结清账单</span
        ><br />
        充值后请及时对支付账单进行结算，以免影响正常服务。在您消费后，DP-Cloudserver
        将基于您的消费进行发票开具<br />
      </div>
      <div class="understand">
        <Checkbox v-model="understand" class="understandCheckBox"></Checkbox>
        <span class="understandTip"
          >我已了解：充值的款项只可用于DP-Cloudserver消费，如需提现，DP-Cloudserver只支持原路退回至付款账户。</span
        >
      </div>
      <Button
    ...
    <div v-if="payment == 'offline'">
      <div class="tips">
        <span style="color: #333333">温馨提示：</span> <br />
        受银行处理时间影响，线下汇款方式会有延误，<span style="color: #ff0000"
          >强烈建议支付宝到账。</span
        ><br />
        线下汇款直接向来的专属账户汇款，系统会将汇款直接匹配到您的阿里云账户。各种方式的到账时间一般为：招行1-2天，跨行2-5天（具体到账时间以银行的实际到账时间为准）。<a
          >更多详情</a
        ><br />
        <span style="color: #ff0000"
          >DP-Cloudserver只支持原路退回至付款账户，请慎重选择充值付款账号</span
        ><br />
        请避免北京时间21:00-00:00进行汇款，否则受银行出账时间影响，可能出现延迟一天到账情况。<br />
      </div>
      <div class="offline">
        ...
        <div class="accountName">
          <span class="accountName_title">开户名称：</span>
          <span class="accountName_data">北京深势科技有限公司</span>
        </div>
        <div class="accountBank">
          <span class="accountBank_title">开户银行：</span>
          <img
